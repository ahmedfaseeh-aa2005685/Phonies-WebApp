...
INSERT INTO "new_Phone" ("brand", "featured", "id", "img", "name", "price", "quantity", "seller", "sold", "storage") SELECT "brand", "featured", "id", "img", "name", "price", "quantity", "seller", "sold", "storage" FROM "Phone";
DROP TABLE "Phone";
